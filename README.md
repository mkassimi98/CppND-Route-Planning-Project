...
```
git clone https://github.com/mkassimi98/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:mkassimi98/CppND-Route-Planning-Project.git --recurse-submodules
```
